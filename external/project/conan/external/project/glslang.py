...
class GlslangConan(ConanFile):
    ...
    def export_sources(self):
        copy(self, "glslang_CMakeLists.txt", self.recipe_folder, self.export_sources_folder)
        rename(self, os.path.join(self.export_sources_folder, "glslang_CMakeLists.txt"), os.path.join(self.export_sources_folder, "CMakeLists.txt"))
    ...
    def source(self):
        get(self, **self.conan_data["glslang"][self.version], strip_root=True)
