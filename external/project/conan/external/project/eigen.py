...
class EigenConan(ConanFile):
    ...
    def source(self):
        get(self, **self.conan_data["eigen"][self.version],
    ...
    def build(self):
        ...
        for file in ['blas/CMakeLists.txt', 'test/CMakeLists.txt', 'lapack/CMakeLists.txt']:
            filepath = os.path.join(self.source_folder, file)
            replace_in_file(self, filepath, 'workaround_9220', '#workaround_9220')
