...
class ProtobufConan(ConanFile):
    ...
    def export_sources(self):
        ...
        copy(self, "protobuf-conan-protoc-target.cmake", os.path.join(self.recipe_folder, "cmake"), os.path.join(self.export_sources_folder, "src"))
    ...
    def source(self):
        get(self, **self.conan_data["protobuf"][self.version], strip_root=True)
    ...
    def _patch_sources(self):
        ...
        # Xreal add for Fix linker errors on Windows with clang in linking protoc
    ...
    def package(self):
        ...
        copy(self, "protobuf-conan-protoc-target.cmake", self.source_folder, dst=cmake_config_folder)
    ...
    def package_info(self):
        ...
        if self._protobuf_release >= "22.0":
            absl_deps = [f"abseil::{c}" for c in self.conan_data["protobuf_absl_deps"][self.version]]
