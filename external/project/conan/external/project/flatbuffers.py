...
class FlatbuffersConan(ConanFile):
    ...
    def source(self):
        get(self, **self.conan_data["flatbuffers"][self.version], strip_root=True)
        self._patch_sources()
    ...
    def _patch_sources(self):
        ...
        cmake_build_flatbuffers = os.path.join(self.source_folder, "CMake", "BuildFlatBuffers.cmake")
        replace_in_file(self, cmake_build_flatbuffers, "CMAKE_CURRENT_SOURCE_DIR", "CMAKE_CURRENT_BINARY_DIR")
